...
/**/
#define _ENABLE_DEFAULE_CFG     0   /* 是否使用默认配置：1:使用shell_cfg.h中的配置,0:使用bsp_shell_cfg.h中的用户配置 */


#if (0 == _ENABLE_DEFAULE_CFG)
#define SHELL_CFG_BSP "bsp_shell_cfg.h"
#endif

#ifdef SHELL_CFG_BSP    
#include SHELL_CFG_BSP
#endif
